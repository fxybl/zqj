...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		//todo zqj 放进DefaultListableBeanFactory中的beanDefinitionMap中，也就是注册beanName
		//todo zqj next DefaultListableBeanFactory
		...
		if (aliases != null) {
			for (String alias : aliases) {
				//todo zqj 注册别名，也就是name属性.其实质就是一个map,alias-->beanName,在SimpleAliasRegistry中的aliasMap。BeanFactory继承了此类
				//todo zqj next GenericApplicationContext
